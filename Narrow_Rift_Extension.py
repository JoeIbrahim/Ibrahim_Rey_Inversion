...
Model.outputDir="Narrow_Rift_Extension_O"
...
coords_FSE_Mantle = GEO.circles_grid(radius=1.5 * u.kilometer, 
                    minCoord=[Model.minCoord[0], -155.*u.kilometer], 
...
Model.run_for(8000000 * u.years, checkpoint_interval=100000. * u.year, restartStep=-1, restartDir="Narrow_Rift_Extension_O")
